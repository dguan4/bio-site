...
// Inline SVG brand icons (avoids lucide v1 removing brand logos)
...
function getIcon(platform: string): IconComponent {
  return ICON_MAP[platform.toLowerCase()] ?? ExternalLink;
}
